...
public class InformesLegalesView  extends VerticalLayout {
    ...
    public InformesLegalesView(){
        ...
        File InformeAnual = new File("src/main/resources/META-INF/resources/files/Informe_Anual.pdf");
        ...
        File InformeDeCumplimiento = new File("src/main/resources/META-INF/resources/files/Informe_De_Cumplimiento.pdf");
        ...
        File InformeDeGestionDeRiesgos = new File("src/main/resources/META-INF/resources/files/Informe_De_Gestion_De_Riesgos.pdf");
        ...
        File InformeDeGobiernoCorporativo = new File("src/main/resources/META-INF/resources/files/Informe_De_Gobierno_Corporativo.pdf");
        ...
        File InformeDeSostenibilidad = new File("src/main/resources/META-INF/resources/files/Informe_De_Sostenibilidad.pdf");
